...
#define WITH_EVENT_RECORDER_PLAYER
...
ret_t event_recorder_player_start_record(const char* filename) {
  ...
  return_value_if_fail(wm->global_emitter != NULL, RET_BAD_PARAMS);
  emitter_on(wm->global_emitter, EVT_POINTER_DOWN, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_POINTER_MOVE, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_POINTER_UP, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_WHEEL, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_KEY_DOWN, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_KEY_UP, event_recorder_player_on_input_event, p);
  emitter_on(wm->global_emitter, EVT_USER_START+1, event_recorder_player_on_input_event, p);
