...
#define UI_VOICE_PHOTO_SRC "/mnt/data/bin/voice/shutter.wav"
#define UI_VOICE_FOCUS_IDX (4)
#define UI_VOICE_FOCUS_SRC "/mnt/data/bin/voice/AF22.wav"
...
typedef void (*smile_photo_callback_t)(void);
