...
#define FT_DEFINE_SERVICE_METRICSVARIATIONSREC(class_, hadvance_adjust_, lsb_adjust_, rsb_adjust_, vadvance_adjust_,   \
                                               tsb_adjust_, bsb_adjust_, vorg_adjust_, metrics_adjust_)                \
    static const FT_Service_MetricsVariationsRec class_ = {hadvance_adjust_, lsb_adjust_,    rsb_adjust_,              \
