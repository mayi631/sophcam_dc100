...
#define FT_DEFINE_SERVICE_MULTIMASTERSREC(class_, get_mm_, set_mm_design_, set_mm_blend_, get_mm_blend_, get_mm_var_,  \
                                          set_var_design_, get_var_design_, set_instance_, set_weightvector_,          \
                                          get_weightvector_, get_var_blend_, done_blend_)                              \
    static const FT_Service_MultiMastersRec class_ = {                                                                 \
        get_mm_,         set_mm_design_, set_mm_blend_,     get_mm_blend_,     get_mm_var_,    set_var_design_,        \
        get_var_design_, set_instance_,  set_weightvector_, get_weightvector_, get_var_blend_, done_blend_};
