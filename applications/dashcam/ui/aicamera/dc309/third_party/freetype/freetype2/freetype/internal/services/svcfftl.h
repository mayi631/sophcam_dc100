...
#define FT_DEFINE_SERVICE_CFFLOADREC(class_, get_standard_encoding_, load_private_dict_, fd_select_get_,               \
                                     blend_check_vector_, blend_build_vector_)                                         \
    static const FT_Service_CFFLoadRec class_ = {get_standard_encoding_, load_private_dict_, fd_select_get_,           \
                                                 blend_check_vector_, blend_build_vector_};
