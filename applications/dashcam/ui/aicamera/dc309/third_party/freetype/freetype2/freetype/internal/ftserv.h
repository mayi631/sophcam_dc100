...
#define FT_DEFINE_SERVICEDESCREC8(class_, serv_id_1, serv_data_1, serv_id_2, serv_data_2, serv_id_3, serv_data_3,      \
                                  serv_id_4, serv_data_4, serv_id_5, serv_data_5, serv_id_6, serv_data_6, serv_id_7,   \
                                  serv_data_7, serv_id_8, serv_data_8)                                                 \
    static const FT_ServiceDescRec class_[] = {                                                                        \
        {serv_id_1, serv_data_1}, {serv_id_2, serv_data_2}, {serv_id_3, serv_data_3},                                  \
        {serv_id_4, serv_data_4}, {serv_id_5, serv_data_5}, {serv_id_6, serv_data_6},                                  \
        {serv_id_7, serv_data_7}, {serv_id_8, serv_data_8}, {NULL, NULL}};

#define FT_DEFINE_SERVICEDESCREC9(class_, serv_id_1, serv_data_1, serv_id_2, serv_data_2, serv_id_3, serv_data_3,      \
                                  serv_id_4, serv_data_4, serv_id_5, serv_data_5, serv_id_6, serv_data_6, serv_id_7,   \
                                  serv_data_7, serv_id_8, serv_data_8, serv_id_9, serv_data_9)                         \
    static const FT_ServiceDescRec class_[] = {{serv_id_1, serv_data_1}, {serv_id_2, serv_data_2},                     \
                                               {serv_id_3, serv_data_3}, {serv_id_4, serv_data_4},                     \
...
#define FT_DEFINE_SERVICEDESCREC10(class_, serv_id_1, serv_data_1, serv_id_2, serv_data_2, serv_id_3, serv_data_3,     \
                                   serv_id_4, serv_data_4, serv_id_5, serv_data_5, serv_id_6, serv_data_6, serv_id_7,  \
                                   serv_data_7, serv_id_8, serv_data_8, serv_id_9, serv_data_9, serv_id_10,            \
                                   serv_data_10)                                                                       \
    static const FT_ServiceDescRec class_[] = {{serv_id_1, serv_data_1},                                               \
                                               {serv_id_2, serv_data_2},                                               \
                                               {serv_id_3, serv_data_3},                                               \
