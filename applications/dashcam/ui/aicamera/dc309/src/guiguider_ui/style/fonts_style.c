...
{
    // 初始化字体样式对象
    lv_style_t* style_list[] = { &ttf_font_12, &ttf_font_14, &ttf_font_16, &ttf_font_18, &ttf_font_20,
        &ttf_font_22, &ttf_font_24, &ttf_font_28, &ttf_font_30, &ttf_font_34 };
    ...
    set_chs_fonts(ALI_PUHUITI_FONTPATH, 28, &ttf_font_28);
    set_chs_fonts(ALI_PUHUITI_FONTPATH, 30, &ttf_font_30);
    set_chs_fonts(ALI_PUHUITI_FONTPATH, 34, &ttf_font_34);
}
