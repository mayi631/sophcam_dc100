...
bool ui_common_cardstatus(void)
{
    switch(MODEMNG_GetCardState()) {
        case CARD_STATE_REMOVE: ui_event_type = EVT_NO_SDCARD; break;
        case CARD_STATE_AVAILABLE:
            return true;
            break;
        case CARD_STATE_ERROR: ui_event_type = EVT_SDCARD_ERROR; break;
        case CARD_STATE_FSERROR:
        case CARD_STATE_UNAVAILABLE: ui_event_type = EVT_SDCARD_NEED_FORMAT; break;
        case CARD_STATE_SLOW: ui_event_type = EVT_SDCARD_SLOW; break;
        case CARD_STATE_CHECKING: ui_event_type = EVT_SDCARD_CHECKING; break;
        case CARD_STATE_READ_ONLY: ui_event_type = EVT_SDCARD_READ_ONLY; break;
        case CARD_STATE_MOUNT_FAILED: ui_event_type = EVT_SDCARD_MOUNT_FAILED; break;
