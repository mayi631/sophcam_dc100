...
int32_t    ini_getbool(const mTCHAR *Section, const mTCHAR *Key,int32_t  DefValue, const mTCHAR *Filename);
long  ini_getl(const mTCHAR *Section, const mTCHAR *Key, long DefValue, const mTCHAR *Filename);
int32_t    ini_gets(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *DefValue, mTCHAR *Buffer,int32_t  BufferSize, const mTCHAR *Filename);
int32_t    ini_getsection(int32_t  idx, mTCHAR *Buffer,int32_t  BufferSize, const mTCHAR *Filename);
int32_t    ini_getkey(const mTCHAR *Section,int32_t  idx, mTCHAR *Buffer,int32_t  BufferSize, const mTCHAR *Filename);
...
int32_t    ini_putl(const mTCHAR *Section, const mTCHAR *Key, long Value, const mTCHAR *Filename);
int32_t    ini_puts(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, const mTCHAR *Filename);
#if defined INI_REAL
int32_t    ini_putf(const mTCHAR *Section, const mTCHAR *Key, INI_REAL Value, const mTCHAR *Filename);
#endif
#endif /* INI_READONLY */

#if !defined INI_NOBROWSE
 typedef int32_t (*INI_CALLBACK)(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, void *UserData);
int32_t   ini_browse(INI_CALLBACK Callback, void *UserData, const mTCHAR *Filename);
#endif /* INI_NOBROWSE */
  ...
  public:
    ...
    bool getbool(const std::string& Section, const std::string& Key, bool DefValue=false) const
      { return ini_getbool(Section.c_str(), Key.c_str(),int32_t (DefValue), iniFilename.c_str()) != 0; }
   ...
   int32_t  geti(const std::string& Section, const std::string& Key,int32_t  DefValue=0) const
      { return static_cast<int32_t >(this->getl(Section, Key, long(DefValue))); }
    ...
    std::string getsection(int32_t  idx) const
      {
        char buffer[INI_BUFFERSIZE];
    ...
    std::string getkey(const std::string& Section,int32_t  idx) const
      {
        char buffer[INI_BUFFERSIZE];
    ...
    bool put(const std::string& Section, const std::string& Key,int32_t  Value)
